...
\begin{itemize}
    ...
    \item \textbf{Memory-Resident Graph Layout}: We bypass runtime geometry parsing and allocation overheads by keeping the compiled graph topology pre-allocated in virtual memory, guaranteeing fast direct memory lookups~\cite{drepper2007memory}.
