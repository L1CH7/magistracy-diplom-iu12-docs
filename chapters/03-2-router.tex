...
Реализация механизма (\ref{eq:dynamic-bbox}), описанного в первой главе, выполнена на уровне SQL-запроса (листинг \ref{lst:dynamic-bbox-sql}).

\begin{code}{dynamic-bbox-sql}{SQL}{Расчет динамического ограничивающего прямоугольника (pgrouting\_engine.py)}
SELECT ST_Expand(
