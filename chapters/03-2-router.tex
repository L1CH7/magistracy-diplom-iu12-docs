...
Для сокращения пространства перебора применяется техника адаптивного ограничивающего прямоугольника. Размер буфера зависит от расстояния между точками старта и финиша (листинг \ref{lst:dynamic-bbox-sql}).
