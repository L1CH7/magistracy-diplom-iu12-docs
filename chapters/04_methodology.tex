...
\begin{itemize}
\item \textbf{Localized Profile}: Journeys under 5 km. Graph traversal overhead is small. Initialization and stack cleanup costs dominate the execution profile.
\item \textbf{Regional Profile}: Journeys between 5 and 25 km. Traversal cost and queue operations exhibit equal latency footprints. 
\item \textbf{Megalopolis Profile}: Journeys exceeding 25 km. The priority queue hot loop determines the execution time. 
\end{itemize}
